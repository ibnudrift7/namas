<footer class="foot">
	<!-- <div class="prelative container"> -->
		...
		<div class="row no-gutters">
				...
				<div class="lefts_cont pl-5 ml-5">
					...
					<div class="blocks_socmed">
						<p class="d-inline-block pr-3">
							...
							<i class="fa fa-whatsapp"></i> &nbsp;081 5530 78875 <a href="https://wa.me/6281553078875">(Click To Chat)</a>
						</p>
			...
			<div class="col-md-22">
				<div class="pc_banner"><img src="<?php echo $this->assetBaseurl ?>picts_rgh_footer.jpg" alt="" class="img img-fluid w-100"></div>
			</div>
		</div>
